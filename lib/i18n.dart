...
class I18n {
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'tts_voice': 'Voice',
      'tts_no_languages': 'No languages loaded. Tap refresh to retry.',
      'tts_no_voices': 'No voices loaded. Tap refresh to retry.',
      'tts_reload_languages_voices': 'Reload languages and voices',
    ...
    'zh': {
      ...
      'tts_language': '语言',
      'tts_voice': '音色',
      'tts_no_languages': '未加载到语言，请点击刷新重试。',
      'tts_no_voices': '未加载到音色，请点击刷新重试。',
      'tts_reload_languages_voices': '重新加载语言和音色',
      'speech_rate': '语速',
      'volume': '音量',
      'pitch': '音调',
      'about': '关于',
